...
function loadModelOnce(modelType) {
    return new Promise((resolve, reject) => {
        loader.load(`/${modelType}.glb`, function (gltf) {
...
(async function () {
    ...
    textures = {
        ...
        riverlandGrass: await new THREE.TextureLoader().loadAsync('/riverland_grass.png'),
        riverlandStone: await new THREE.TextureLoader().loadAsync('/riverland_stone.png'),
        dirt: await new THREE.TextureLoader().loadAsync('/farm_dirt.png'),
        farmGrass: await new THREE.TextureLoader().loadAsync('/farm_grass.png'),
        hay: await new THREE.TextureLoader().loadAsync('/hay.png'),
        clay: await new THREE.TextureLoader().loadAsync('/clay.png'),
        clayStone: await new THREE.TextureLoader().loadAsync('/clay_stone.png'),
        snow: await new THREE.TextureLoader().loadAsync('/snow.png')
    };
